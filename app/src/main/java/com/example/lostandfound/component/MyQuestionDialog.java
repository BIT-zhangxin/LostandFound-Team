...
//新建的可以回答问题的dialog
public class MyQuestionDialog extends AlertDialog implements View.OnClickListener{
    ...
    private TextView tv_question;//标题
    ...
    private String questionStr="";//标题文本
    private String trueButtonStr="";//确认按钮文本
    private String falseButtonStr="";//取消按钮文本
    private boolean falseButtonHidden =false;//是否隐藏取消按钮

    public MyQuestionDialog(Context context,int iconImgResId,String titleStr,String confirmBtnTvStr, String cancelBtnTvStr, boolean falseButtonHidden) {
        //设置对话框样式
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_question_alert_dialog_layout);
        initComponent();
        initView();
        initEvent();
    }
    ...
    private void initComponent(){
        ...
        tv_question= findViewById(R.id.tv_my_question_alert_dialog_question);
        et_answer = findViewById(R.id.et_my_question_alert_dialog_answer);
